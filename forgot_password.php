        ...
        if($user->emailExists()){
            ...
            if($user->updateAccessCode()){
                ...
                if($utils->sendEmailViaPhpMail($send_to_email, $subject, $body)){
                    echo "<div class='alert alert-info'>Password reset link was sent to your email.
                    Click that link to reset your password.</div>";
                }
    ...
    echo "<div class='account-wall'>
        <div id='my-tab-content' class='tab-content'>
            <div class='tab-pane active' id='login'>
                <img class='profile-img' src='images/default-avatar.png'>
                <form class='form-signin' action='" . htmlspecialchars($_SERVER["PHP_SELF"]) . "' method='post'>
                    ...
                    <input type='submit' class='btn btn-lg btn-primary btn-block' value='Reset Password' style='margin-top:1em;' />
                </form>
            </div>
        </div>
    </div>";
